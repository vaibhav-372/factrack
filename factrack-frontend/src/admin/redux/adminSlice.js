...
export const addManager = createAsyncThunk('managers/add', async (manager) => {
  const res = await axios.post('http://localhost:5000/api/admin/managers', manager);
  return res.data;
});

// DELETE manager
// export const deleteManager = createAsyncThunk('managers/delete', async (id) => {
//   await axios.delete(`http://localhost:5000/api/admin/managers/${id}`);
//   return id;
// });

// UPDATE manager
// export const updateManager = createAsyncThunk('managers/update', async (manager) => {
//   const res = await axios.put(`http://localhost:5000/api/admin/managers/${manager._id}`, manager);
//   return res.data;
// });
